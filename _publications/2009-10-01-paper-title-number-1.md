...
Privacy, Machine Learning for Communication, and distributed system.</br>
  ...
  <tbody>
   ...
   <td>
					...
					<b>	
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/PUF.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						...
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper1.pdf"><font style="font-size:14pt; color:#0e228a;"> Countering Modeling Attacks in PUF-based IoT Security Solutions </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>, Wassila Lalouani, Mohamed Younis, Mohammad Ebrahimabadi, Naghmeh Karimi </font> <br>
							<font style="font-size:12pt; color:#686868;"> ACM Journal on Emerging Technologies in Computing Systems  (<b>JETC</b>), 2020 </font> <br>
			...
			<!-- PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/IEEEsystem.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper2.pdf"><font style="font-size:14pt; color:#0e228a;"> Blockchain-enabled and Data-driven Smart Healthcare Solution for Secure and Privacy-Preserving Data Access </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Mohamed Younis , Wassila Lalouani , Noureddine Lasla, Lloyd Emokpae , and Mohamed Abdallah </font> <br>
							<font style="font-size:12pt; color:#686868;"> IEEE Systems Journal, 2021 </font> <br>
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper2.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/CCN.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper3.pdf"><font style="font-size:14pt; color:#0e228a;"> Robust and Efficient Data Security Solution for Pervasive Data Sharing in IoT </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Wassila Lalouani, Mohamed Younis, Mohammad Ebrahimabadi, Naghmeh Karimi </font> <br>
							<font style="font-size:12pt; color:#686868;"> IEEE Consumer Communications & Networking Conference (<b>CCNC</b>), 2022 </font> <br>
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper3.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div></div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/beam.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper4.pdf"><font style="font-size:14pt; color:#0e228a;"> Countering radiometric signature exploitation using adversarial machine learning based protocol switching</font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Wassila Lalouani, Mohamed Younis, Uthman Baroudi </font> <br>
							<font style="font-size:12pt; color:#686868;"> The International Journal for the Computer and Telecommunications Industry (<b></b>), 2021 </font> <br>
						
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper4.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
						</div>		</div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/smart.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper5.pdf"><font style="font-size:14pt; color:#0e228a;"> Energy-Efficient Collection of Wearable Sensor Data through Predictive Sampling, Smart Health Journal </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Wassila Lalouani , Mohamed Younis , Ian White-Gittens ,
Roland N. Emokpae Jr. , Lloyd E. Emokpae</font> <br>
							<font style="font-size:12pt; color:#686868;"> Smart Health Journal (<b></b>), 2021 </font> <br>
										
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper5.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div> </div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/GB.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper6.pdf"><font style="font-size:14pt; color:#0e228a;"> Robust Distributed Intrusion Detection System for Edge of Things </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>,  Wassila Lalouani, Mohamed Younis </font> <br>
							<font style="font-size:12pt; color:#686868;"> IEEE Global Communications Conference (<b>GlobeCom</b>), 2020 </font> <br>
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper6.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div> </div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/telehealth.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper7.pdf"><font style="font-size:14pt; color:#0e228a;"> Smart Multi-modal Telehealth IoT System for COVID-19 Patients </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Lloyd E. Emokpae, Wassila Lalouani, Mohamed Younis and Roland N. Emokpae, Jr.c </font> <br>
							<font style="font-size:12pt; color:#686868;">IEEE Pervasive Computing  (<b></b>), 2021 </font> <br>
													
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper7.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div></div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						...
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper8.pdf"><font style="font-size:14pt; color:#0e228a;"> A Novel Modeling-Attack Resilient Arbiter-PUF Design </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Mohammad Ebrahimabadi, Mohamed Younis, Wassila Lalouani, and Naghmeh Karimi </font> <br>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						...
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper9.pdf"><font style="font-size:14pt; color:#0e228a;"> An Attack Resilient PUF-based Authentication Mechanism for Distributed Systems </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b> Mohammad Ebrahimabadi, Wassila Lalouani, Mohamed Younis, and Naghmeh Karimi </font> <br>
							<font style="font-size:12pt; color:#686868;"> International Conference on  (<b>Globe</b>), 2020 </font> <br>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						...
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper10.pdf"><font style="font-size:14pt; color:#0e228a;"> Countering PUF Modeling Attacks through Adversarial Machine Learning </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>Mohammad Ebrahimabadi, Wassila Lalouani, Mohamed Younis, and Naghmeh Karimi </font> <br>
							<font style="font-size:12pt; color:#686868;"> International Conference on  (<b>Globe</b>), 2020 </font> <br>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						...
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper11.pdf"><font style="font-size:14pt; color:#0e228a;"> Adaptive Traffic Lights Control System for Mixed Traffic of Connected Autonomous Vehicles (CAVs) and Human-Driven Vehicles (HVs) </font></a><br>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/grid.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper12.pdf"><font style="font-size:14pt; color:#0e228a;"> Machine Learning Enabled Secure Collection of Phasor Data in Smart Power Grid Networks </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>, Wassila Lalouani, Mohamed Younis </font> <br>
							<font style="font-size:12pt; color:#686868;"> International Conference on Mobility, Sensing and Networking   (<b>MSN</b>), 2021 </font> <br>
	  		
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper12.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div></div>
							</a>
             ...
             <!-- end PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/muser.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper13.pdf"><font style="font-size:14pt; color:#0e228a;"> Multi-observable Reputation Scoring System for Flagging Suspicious User Sessions </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b> Wassila Lalouani, Mohamed Younis </font> <br>
							<font style="font-size:12pt; color:#686868;"> The International Journal of Computer and Telecommunications Networking  (<b>COMNET</b>), 2020 </font> <br>
        	...
        	<!-- PAPER:1 -->
					...
					<div class="col-md-12">
						<div class="col-md-2 project-panel-image" style="background-image: url(./images/fingerprint.png); background-size: 100%; background-repeat: no-repeat; background-position: center; height:100px; width:135px; border: 1px solid #0e228a;
						background-color: #EBEBEB;">
						</div>
						<div class="col-md-8">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>		
							<p> <a href="./paper/paper14.pdf"><font style="font-size:14pt; color:#0e228a;"> Adversarial Machine Learning based Protocol Switching Mechanism for Countering Radiometric Signature Exploitation </font></a><br>
							<font style="font-size:12pt; color:#686868;"><b></b>, Wassila Lalouani, Mohamed Younis, Danila Frolov, Uthman Baroudi </font> <br>
							<font style="font-size:12pt; color:#686868;"> IEEE International Conference on Communications  (<b>ICC</b>), 2020 </font> <br>
					
						<div class="col-md-2">
						<div class="space_1px"> </div>
							<div class="space_1px"> </div>
							<div class="space_1px"> </div>
						<a href="./paper/paper14.pdf">
								<div class="publication-button">
									<p class="text-center"> PDF</p>
								</div></div>
							</a>
